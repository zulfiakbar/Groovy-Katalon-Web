...
//		WebUI.uploadFile(findTestObject('Page_EditProduct/img_ImageField'), System.getProperty('user.dir') + '"C:\\Users\\User\\git\\secondhand-web\\Asset\\Image\\longdress (1).jpg"')
